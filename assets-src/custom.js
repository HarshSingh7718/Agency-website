(function () {
  ...
  ready(function () {
    doc.querySelectorAll(".sol-media").forEach(function (m) {
      var b = m.querySelector(".follow-badge");
      if (!b) return;
    ...
    (mqDesktop.addEventListener
      ...
      : mqDesktop.addListener.bind(mqDesktop))(function () {
      if (mqDesktop.matches) closeDrawer(false);
    });

    doc
      .querySelectorAll(".main-nav .has-children > a")
    ...
    doc.addEventListener("click", function (e) {
      if (!e.target.closest(".has-children"))
        doc.querySelectorAll(".has-children.is-open").forEach(function (p) {
    ...
    window.addEventListener("resize", function () {
      doc.querySelectorAll(".faq .item.is-open .a").forEach(function (a) {
        a.style.maxHeight = a.scrollHeight + "px";
      });
    });
    ...
    doc.querySelectorAll(".wp-mock").forEach(function (mock) {
      ...
      function activate(name) {
        ...
        panels.forEach(function (pn) {
          pn.classList.toggle(
            "is-active",
            pn.getAttribute("data-panel") === name
          );
        });
      }
      tabs.forEach(function (t) {
        t.addEventListener("click", function () {
          activate(t.getAttribute("data-wpm"));
        });
      });
      ...
      if (wrap) {
        ...
        if (start && mock.querySelector('[data-wpm="' + start + '"]'))
          activate(start);
      }
    });
